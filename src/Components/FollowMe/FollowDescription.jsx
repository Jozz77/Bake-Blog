...
const FollowDescription = (props) => {
  return (
    <div className=" bg-[#B5C7A5] absolute top-0 left-0 bottom-0 right-0 py-[2vh] px-[5%] ssm:py-[1vh] ssm:text-[1.1rem] sm:py-[2vh] lg:y-[1vh] xl:py-[2vh]">
      ...
      <Link to='' className="hover:bg-[#370E00] hover:text-[#F3F6F1] border-[#370E00] border-solid border-[1px] rounded-[8px] bg-[#F3F6F1] py-[0.7vh] px-[5%] text-[1rem] font-bold font-IBM text-[#370E00] leading-[120%] ssm:text-[0.75rem] md:py-[0.7vh] sm:text-[1rem] sm:py-[1vh] md:text-[0.8rem]  xl:text-[1rem]">Read More</Link>
    </div>
  );
};
