...
export default function Header() {
  return (
    <header className='flex fixed w-full justify-between px-[5%] py-[2vh] '>
        ...
        <section className='flex w-[55%] justify-between items-center '>
            ...
            <Link to='' className='text-normal text-[#370E00] text-[1.4rem] leading-[32px]'>Recipes</Link>
            <Link to='' className='text-normal text-[#370E00] text-[1.4rem] leading-[32px]'>About</Link>
            <Link to='' className='text-normal text-[#370E00] text-[1.4rem] leading-[32px]'>Contact</Link>
            <div>
