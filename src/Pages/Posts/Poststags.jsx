  ...
  return (
    <div>
      ...
      <div className="flex gap-[2%] my-[2vh]">
        <Link to=''><ImFacebook className="text-[1.2rem] text-[#370E00]" /></Link>
        <Link to=''><AiOutlineInstagram className="text-[1.2rem] text-[#370E00]" /></Link>
        <Link to=''><CiTwitter className="text-[1.2rem] text-[#370E00]" /></Link>
      </div>
      <hr />
