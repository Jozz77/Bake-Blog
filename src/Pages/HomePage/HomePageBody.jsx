  ...
  return (
    <div className="">
      <section className="px-[5%] flex justify-between items-center mt-[15vh] ">
        <div className="Life-Hero relative py-[8vh] w-[65%] lg:py-[13vh]">
          <div>
            <div className="Life-Gives">
              <h2 className="font-semibold text-center text-[#FFFFFF] px-[7%] text-[2.3rem] leading-[130%] lg:leading-[130%] md:text-[2.6rem] lg:text-[3.4rem] xl:text-[3.8rem]">
                When Life Gives You Flour and Butter, You Better Bake
              </h2>
              <Link to="">
                <button className="text-[#370E00] font-normal text-[1.1rem] w-[30%] mt-[3vh] mx-[35%] leading-[24px] bg-[#F3F6F1] py-[1.5vh] md:text-[1.3rem] lg:mt-[5vh]">
                  All Recipes
                </button>
              </Link>
            </div>
      ...
      <section className="px-[5%] flex relative py-[5vh]">
        <div className="w-[50%] mr-[-5%] my-[3%] bg-[#F3F6F1] z-[1]">
          ...
          <p className="text-[#370E00] font-IBM font-normal text-[1.4rem] leading-[130%] pr-[5%] mb-[3vh] ">
          ...
          <Link
            to=""
            className="hover:bg-[#B5C7A5] hover:border-[#B5C7A5] text-[#370E00] font-IBM font-normal text-[1.4rem] border-solid border-[#000000] border-[0.5px] py-[1vh] px-[5%] leading-[130%]"
          >
            About Me
          </Link>
        </div>
