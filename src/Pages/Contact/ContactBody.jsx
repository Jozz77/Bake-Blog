    ...
    <div className="mt-[15vh]">
      <section>
        ...
        <div className="px-[5%] pt-[2vh] md:px-[10%] lg:px-[15%]">
          <h1 className="text-center font-normal text-[1.8rem] text-[#370E00] leading-[150%] px-[10%] lg:text-[2rem] lg:px-[20%]  ">Have Comments, Questions or Business Proposals?</h1>
          <form action="" className="flex flex-wrap gap-x-[2%] gap-y-[3vh] font-IBM pt-[3vh] lg:pt-[6vh]">
            <div className="w-[49%] text-[1.2rem] text-[#370E00] leading-[130%]">
            ...
            <textarea name="" id="" cols="30" rows="10" className="resize-none w-full mt-[1vh] pt-[2vh] px-[2%] text-[1.2rem] text-[#370E00] leading-[130%] border-[#370E00] border-[1px] border-solid bg-transparent outline-none "></textarea>
            <div className="flex justify-end w-full">
              <button className="py-[1vh] px-[2%] text-right rounded-[8px] font-bold   text-[1.1rem] text-[#370E00] border-[#370E00] border-[1px] border-solid bg-transparent ">Submit</button>
            </div>
          </form>
        </div>
      </section>
